...
import static com.nhattuan.growrichs.Activity.AlarmNightActivity.alarmNightActivity;

public class AlarmActivity extends AppCompatActivity implements MediaController.MediaPlayerControl {
    ...
    private void setMorning() {
        ...
        if (am_pm.equals("PM")) timePicker.setCurrentHour(timePicker.getCurrentHour() - 12);
    }
    ...
    private void setOnClick() {
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent myIntent = new Intent(getApplicationContext(), AlarmReceiverMorning.class);
        ...
        btn_ring_tone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentListSong = new Intent(AlarmActivity.this, ListSongActivity.class);
    ...
    private void setAlarm(PendingIntent pendingIntent) {
        ...
        sessionManager.setMorning(objPick);
    ...
    private void mapWiget() {
        ...
        snoozeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent snoozeIntent = new Intent(AlarmActivity.this, SnoozeActivity.class);
    ...
    private void setTimePicker() {
        ...
        ObjPick objPick = new SessionManager(this).getMorning();
        if (objPick != null) {
            Calendar creatTime = Calendar.getInstance();
            creatTime.setTimeInMillis(objPick.getmCreateTime());
            Log.d(TAG, "setTimePicker: " +
                    creatTime.get(Calendar.DATE)
                    + " " + creatTime.get(Calendar.HOUR_OF_DAY) + " " + creatTime.get(Calendar.MINUTE)
            );
            if (creatTime.get(Calendar.DATE) == calendar.get(Calendar.DATE)+1) {
